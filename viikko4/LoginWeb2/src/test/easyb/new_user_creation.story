...
scenario "creation succesfull with correct username and password", {
    ...
    when 'a valid username and password are entered', {
        ...
        element.sendKeys("finam");
        element = driver.findElement(By.name("password"));
        element.sendKeys("qwer1234");
    ...
    then 'new user is registered to system', {
        driver.getPageSource().contains("new").shouldBe true
    }
}
...
scenario "creation fails with correct username and pasword consisting of letters", {
    ...
    when 'a valid username and password consisting of letters are entered', {
        element = driver.findElement(By.name("username"));
        element.sendKeys("kijana");
        element = driver.findElement(By.name("password"));
        element.sendKeys("giganqqq");
        element = driver.findElement(By.name("passwordConfirmation"));
        element.sendKeys("giganqqq");
        element = driver.findElement(By.name("add"));
        element.submit();
...
scenario "creation fails with already taken username and valid pasword", {
    ...
    then 'new user is not be registered to system', {
        driver.getPageSource().contains("invalid").shouldBe true
    }
}
